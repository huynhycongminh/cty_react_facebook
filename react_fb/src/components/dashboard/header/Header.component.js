  ...
  return (
    <div className="headers">
      ...
      <div className="header_info">
        <Avatar src="https://media-cdn-v2.laodong.vn/Storage/NewsPortal/2020/8/21/829850/Bat-Cuoi-Truoc-Nhung-07.jpg" className="avatar_user" />
        <h4 className="name_user">minh</h4>
      </div>
